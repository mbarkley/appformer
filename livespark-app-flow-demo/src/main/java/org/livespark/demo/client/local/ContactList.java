...
public class ContactList
    ...
    public void onNewContactClick( final Event event ) {
        output.submit( new Command<>( CrudOperation.CREATE,
                                      new Contact() ) );
    }
    ...
    public void editComponent( final @Observes @DoubleClick ContactDisplay component ) {
        ...
        output.submit( new Command<>( CrudOperation.UPDATE,
                                      component.getValue() ) );
    }
    ...
    private void sortContactsByName() {
        binder.pause();
        Collections.sort( binder.getModel(),
                          ( a,
                            b ) -> a.getNickname().compareTo( b.getNickname() ) );
